...
function transliterateBengali(value) {
  return String(value || '').replace(/ক্ষ|[অ-হড়ঢ়য়ৎংঃঁািীুূৃেৈোৌ্]/g, character => BENGALI_TO_LATIN[character] || character);
}
...
module.exports = { englishLabel, readAudioDurationSeconds, enrichAudioDurations };
