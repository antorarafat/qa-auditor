...
const bnCopy = {
  ...
  "Use 192.168.99.0/24 to allow devices on that network.": "ওই নেটওয়ার্কের ডিভাইস অনুমোদন করতে 192.168.99.0/24 ব্যবহার করুন।",
  ...
  "For people on the same Wi‑Fi, use their private LAN range instead (usually 192.168.x.0/24). A public IP does not replace the LAN range for local traffic.": "একই Wi‑Fi-এর মানুষের জন্য private LAN range ব্যবহার করুন (সাধারণত 192.168.x.0/24)। স্থানীয় ট্রাফিকের ক্ষেত্রে পাবলিক IP LAN range-এর বিকল্প নয়।",
  "Step 1": "ধাপ ১",
